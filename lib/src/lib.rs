            ...
            let _ = match optcode {
                ...
                OPTCODE::CallSpecialFunction { function } => {
                    call_special_function!(
                        ...
                        ("apgriezt" => apgriezt),
                        ("mazie_burti" => mazie_burti),
                        ("lielie_burti" => lielie_burti),
                        ("apakšvirkne" => apaksvirkne),
                        ("aizvietot" => aizvietot),
                        ("satur" => satur),
                        ("sākas_ar" => sakas_ar),
                        ("beidzas_ar" => beidzas_ar),
                        ("absolūtā_vērtība" => absoluta_vertiba),
                        ("minimums" => minimums),
                        ("maksimums" => maksimums),
                        ("apaļot" => apalot),
                        ("grīda" => grida),
